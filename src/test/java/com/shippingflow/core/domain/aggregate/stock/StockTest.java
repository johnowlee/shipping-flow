...
//    void assignedTo() {
//        // given
//        Item item = Item.of(1L, "ItemA", 1000L, "This is ItemA");
...
//        // given
//        Item oldItem = Item.of(1L, "ItemA", 1000L, "This is ItemA");
//        Stock stock = Stock.builder().build();
//        stock.assignedTo(oldItem);
//
//        // when
//        Item newItem = Item.of(2L, "ItemB", 3000L, "This is ItemB");
...
//
//        // when
//        stock.addNewTransaction(stockTransaction);
//
//        // then
...
//                .build();
//        Stock stock = Stock.builder().quantity(300L).build();
//        stock.addNewTransaction(oldTransaction);
//
...
//
//        // when
//        stock.addNewTransaction(duplicateTransaction);
//
//        // then
