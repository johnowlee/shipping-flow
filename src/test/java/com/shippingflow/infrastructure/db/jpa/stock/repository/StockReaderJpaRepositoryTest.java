...
//    void findById() {
//        // given
//        Item newItem = Item.create("itemA", 1000L, "this is itemA");
//        ItemEntity newItemEntity = ItemEntity.create(newItem);
//        ItemEntity savedItemEntity = itemJpaRepository.save(newItemEntity);
//        Item savedItem = savedItemEntity.toDomain();
//
//        Stock newStock = Stock.create(savedItem);
//        StockEntity newStockEntity = StockEntity.create(newStock);
